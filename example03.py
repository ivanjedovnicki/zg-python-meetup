"""
A common problem solved by threads involves one thread producing some data, and another
consuming or processing that data. The queue.Queue data structure is used for
thread-safe communication.

Discussion: multiple producers and consumers.
"""
import logging
import queue
import threading
