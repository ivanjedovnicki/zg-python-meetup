"""
The queue.Queue data structure is a good way for communicating between threads. However,
there are some caveats. Not all methods from queue.Queue are thread safe.

Discussion: race conditions; how to help stuck consumers?
"""
import logging
import queue
import threading
